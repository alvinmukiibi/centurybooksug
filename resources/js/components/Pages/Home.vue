                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/7.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/8.jpeg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/9.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/10.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/11.jpg" alt="" class="img-fluid"></a>
                    <div class="col-md-12">
                        <div class="tp-bnd owl-carousel">
                            ...
                            <div class="bnd-items">
                                <a href="#"><img src="century-images/1.jpg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="bnd-items">
                                <a href="#"><img src="century-images/9.jpg" alt="" class="img-fluid"></a>
                            </div>
                            ...
                            <div class="bnd-items">
                                <a href="#"><img src="century-images/12.jpg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="bnd-items">
                                <a href="#"><img src="century-images/2.jpg" alt="" class="img-fluid"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
           ...
           <section class="feat-pro2">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/3.jpg" alt="" class="img-fluid"></a>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/4.jpg" alt="" class="img-fluid"></a>
                    <div class="col-md-4">
                        <div class="sec-title">
                            <h5>Feature Books</h5>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/5.jpg" alt="" class="img-fluid"></a>
                       <div class="feat-box">
                            <img src="images/appliance.jpg" alt="" class="img-fluid">
                    ...
                    <div class="col-md-2">
                        <div class="banner3-box">
                            <a href="#"><img src="century-images/6.jpg" alt="" class="img-fluid"></a>
                    <div class="col-md-8">
                        <div class="row">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="all" role="tabpanel">
                                            <div class="tab-slider owl-carousel">
                                                <div class="tab-item">
                                                    <div class="tab-img">
                                                        <img class="main-img img-fluid" src="century-images/1.jpg" alt="">
                                                        <img class="sec-img img-fluid" src="century-images/1.jpg" alt="">
                                                        <div class="layer-box">
                                                            <a href="" class="it-comp" data-toggle="tooltip" data-placement="left" title="Compare"><img src="images/it-eye.png" alt=""></a>
                                                            <a href="" class="it-fav" data-toggle="tooltip" data-placement="left" title="Favourite"><img src="images/it-fav.png" alt=""></a>
                                                        </div>
                                                    </div>
                                                    <div class="tab-heading">
                                                        <p><a href="">The Origins Of Discontent</a></p>
                                                    </div>
                                                    <div class="img-content d-flex justify-content-between">
                                                        <div>

                                                            <ul class="list-unstyled list-inline price">
                                                                <li class="list-inline-item">50,000 UGX</li>
                                                                <li class="list-inline-item">65,000 UGX</li>
                                                            </ul>
                                                        </div>
                                                        <div>
